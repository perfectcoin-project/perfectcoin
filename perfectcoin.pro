...
android {
    ...
    RESOURCES = perfectcoin.qrc

build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = com.discoverperfectcoin
...
contains(PC_NEED_QT_PLUGINS, 1) {
    DEFINES += PC_NEED_QT_PLUGINS
...
HEADERS += \
    ...
    src/qt/perfectcoingui.h \
    src/qt/perfectcoinbridge.h \
...
SOURCES += \
    ...
    src/qt/perfectcoingui.cpp \
    src/qt/perfectcoin.cpp \
    src/qt/perfectcoinbridge.cpp \
...
macx:ICON = src/qt/res/icons/perfectcoin.icns
macx:TARGET = "PC"
