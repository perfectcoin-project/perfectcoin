...
QString TransactionRecord::getTypeLabel(const int &type)
{
    ...
    case RecvWithAddress:
        return PerfectCoinGUI::tr("Received with");
    case RecvFromOther:
        return PerfectCoinGUI::tr("Received from");
    case SendToAddress:
    case SendToOther:
        return PerfectCoinGUI::tr("Sent to");
    case SendToSelf:
        return PerfectCoinGUI::tr("Payment to yourself");
    case Generated:
        return PerfectCoinGUI::tr("Mined");
    case RecvPerfectCoinX:
        return PerfectCoinGUI::tr("Received PCX");
    case SendPerfectCoinX:
        return PerfectCoinGUI::tr("Sent PCX");
    case Other:
        return PerfectCoinGUI::tr("Other");
    default:
        return "";
    }
}
...
QString TransactionRecord::getTypeShort(const int &type)
{
    ...
    case TransactionRecord::RecvPerfectCoinX:
        return "input";
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
    case TransactionRecord::SendPerfectCoinX:
        return "output";
    default:
        return "inout";
    }
...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet *wallet, const CWalletTx &wtx)
{
    ...
    int64_t nCredPC, nCredPerfectCoinX;
    wtx.GetCredit(nCredPC, nCredPerfectCoinX, true);
    int64_t nCredit = nCredPC + nCredPerfectCoinX;
    ...
    {
        if (nNet > 0 && nCredPerfectCoinX > 0)
        {
            // -- credit
            TransactionRecord sub(hash, nTime, TransactionRecord::RecvPerfectCoinX, "", "", nNet, 0);
        ...
        {
            // -- debit
            TransactionRecord sub(hash, nTime, TransactionRecord::SendPerfectCoinX, "", "", nNet, 0);
        ...
        for (unsigned int nOut = 0; nOut < wtx.vout.size(); nOut++)
        {
                ...
                && txout.IsAnonOutput())
            {
                ...
                if (wallet->HaveKey(ckidD))
                {
                    ...
                    sub.type = TransactionRecord::RecvPerfectCoinX;
    ...
    } else
    {
        ...
        BOOST_FOREACH(const CTxIn& txin, wtx.vin)
        {
                ...
                && txin.IsAnonInput())
            {
                ...
                {
                    fAllFromMe = false;
                    break; // display as send/recv perfectcoin 
                };
                continue;
            };
        ...
        BOOST_FOREACH(const CTxOut& txout, wtx.vout)
        {
            ...
            {
                fAllToMe = false;
                break; // display as send/recv perfectcoinx
            }
        ...
        if (fAllFromMe)
        {
            ...
            for (unsigned int nOut = 0; nOut < wtx.vout.size(); nOut++)
            {
                    ...
                    && txout.IsAnonOutput())
                {
                    ...
                    sub.type = TransactionRecord::SendPerfectCoinX;
                    sub.address = CBitcoinAddress(ckidD).ToString();
