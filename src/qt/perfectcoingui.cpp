...
PerfectCoinGUI::PerfectCoinGUI(QWidget *parent):
    QMainWindow(parent),
    bridge(new PerfectCoinBridge(this)),
    clientModel(0),
    walletModel(0),
    messageModel(0),
    ...
    nWeight(0)
{
    ...
    resize(1280, 720);
    setWindowTitle(tr("PerfectCoin") + " - " + tr("Client"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/perfectcoin"));
    setWindowIcon(QIcon(":icons/perfectcoin"));
#else
...
#ifdef Q_OS_WIN
    QFile html("C:/perfectcoin/index.html");
#else
    QFile html("/opt/perfectcoin/index.html");
#endif
...
void PerfectCoinGUI::pageLoaded(bool ok)
{
...
void PerfectCoinGUI::addJavascriptObjects()
{
    documentFrame->addToJavaScriptWindowObject("bridge", bridge);
}

void PerfectCoinGUI::urlClicked(const QUrl & link)
{
...
void PerfectCoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About PerfectCoin"), this);
    aboutAction->setToolTip(tr("Show information about PerfectCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PerfectCoin"));
...
void PerfectCoinGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
void PerfectCoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if (clientModel)
    {
        ...
        if (mode != NT_FULL)
        {
            ...
            setWindowTitle(tr("PerfectCoin") + " - " + tr("Wallet") + ", " + sMode);
        };
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/perfectcoin_testnet"));
            setWindowIcon(QIcon(":icons/perfectcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/perfectcoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("PerfectCoin client") + QString(" ") + tr("[testnet]"));
                trayIcon->setIcon(QIcon(":/icons/perfectcoin_testnet"));
...
void PerfectCoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void PerfectCoinGUI::setMessageModel(MessageModel *messageModel)
{
...
void PerfectCoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("PerfectCoin client"));
    trayIcon->setIcon(QIcon(":/icons/perfectcoin"));
...
#ifndef Q_OS_MAC
void PerfectCoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void PerfectCoinGUI::aboutClicked()
{
    AboutDialog dlg;
...
void PerfectCoinGUI::setNumConnections(int count)
{
    ...
    connectionsIcon.setAttribute("title", tr("%n active connection(s) to PerfectCoin network", "", count));
}

void PerfectCoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
...
void PerfectCoinGUI::error(const QString &title, const QString &message, bool modal)
{
    // Report errors from network/worker thread
    if(modal)
    {
...
void PerfectCoinGUI::changeEvent(QEvent *e)
{
...
void PerfectCoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void PerfectCoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          "which goes to the nodes that process your transaction and helps to support the network.  "
          "Do you want to pay the fee?").arg(
                BitcoinUnits::formatWithUnit(BitcoinUnits::PC, nFeeRequired));
...
void PerfectCoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
...
void PerfectCoinGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void PerfectCoinGUI::gotoSignMessageTab(QString addr)
{
...
void PerfectCoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void PerfectCoinGUI::optionsClicked()
{
    bridge->triggerElement("#navitems a[href=#options]", "click");
    showNormalIfMinimized();
}

void PerfectCoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void PerfectCoinGUI::dragMoveEvent(QDragMoveEvent *event)
{
    event->accept();
}

void PerfectCoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PerfectCoin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void PerfectCoinGUI::handleURI(QString strURI)
{
...
void PerfectCoinGUI::setEncryptionStatus(int status)
{
...
void PerfectCoinGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void PerfectCoinGUI::backupWallet()
{
...
void PerfectCoinGUI::changePassphrase()
{
...
void PerfectCoinGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void PerfectCoinGUI::lockWallet()
{
    if(!walletModel)
        return;
...
void PerfectCoinGUI::toggleLock()
{
    if(!walletModel)
        return;
...
void PerfectCoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void PerfectCoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void PerfectCoinGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void PerfectCoinGUI::updateStakingIcon()
{
...
void PerfectCoinGUI::detectShutdown()
{
