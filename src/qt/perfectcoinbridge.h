...
class PerfectCoinBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit PerfectCoinBridge(PerfectCoinGUI *window, QObject *parent = 0);
    ~PerfectCoinBridge();
