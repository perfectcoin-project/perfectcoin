...
/**
  PerfectCoin GUI main class. This class represents the main window of the PerfectCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PerfectCoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit PerfectCoinGUI(QWidget *parent = 0);
    ~PerfectCoinGUI();
...
private:
    ...
    friend class PerfectCoinBridge;
