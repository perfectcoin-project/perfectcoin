...
public:
    ...
    enum OptionID {
        ...
        Fee,                 /**< Transaction Fee. qint64 - Optional transaction fee per kB that helps make sure your transactions are processed quickly.
                               *< Most transactions are 1 kB. Fee 0.01 recommended. 0.0001 PC */
        ...
        AutoRedeemPerfectCoinX,    /**< Default Transaction Fee. bool */
    ...
    bool getAutoRedeemPerfectCoinX();
    int getDisplayUnit();
    int getRowsPerPage();
    int getMinRingSize();
    int getMaxRingSize();
