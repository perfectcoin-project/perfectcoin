...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::PC).toInt();
    ...
    fAutoRedeemPerfectCoinX = settings.value("fAutoRedeemPerfectCoinX", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemPerfectCoinX:
            return fAutoRedeemPerfectCoinX;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemPerfectCoinX: return "AutoRedeemPerfectCoinX";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::PC).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemPerfectCoinX: {
            fAutoRedeemPerfectCoinX = value.toBool();
            settings.setValue("fAutoRedeemPerfectCoinX", fAutoRedeemPerfectCoinX);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemPerfectCoinX() { return fAutoRedeemPerfectCoinX; }
