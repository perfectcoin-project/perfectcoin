...
extern json_spirit::Value sendperfectcointoanon(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendanontoanon(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendanontoperfectcoin(const json_spirit::Array& params, bool fHelp);
