...
{
    uiInterface.ThreadSafeMessageBox(str, _("PerfectCoin"), CClientUIInterface::BTN_OK | CClientUIInterface::MODAL);
    return false;
}
...
std::string HelpMessage()
{
    std::string strUsage = _("Options:") + "\n";
        ...
        strUsage += "  -conf=<file>           " + _("Specify configuration file (default: perfectcoin.conf)") + "\n";
        strUsage += "  -pid=<file>            " + _("Specify pid file (default: perfectcoind.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    ********************************************************* */
    ...
    if (nLoadWalletRet != DB_LOAD_OK)
    {
        ...
        {
            strErrors << _("Error loading wallet.dat: Wallet requires newer version of PerfectCoin") << "\n";
        } else
        if (nLoadWalletRet == DB_NEED_REWRITE)
        {
            strErrors << _("Wallet needed to be rewritten: restart PerfectCoin to complete") << "\n";
